...
public class EventServiceTest
{
    ...
    {
        var eventItem = await _eventService.GetByIdAsync(new Guid(id), CancellationToken.None);
    ...
    public async Task SearchNonExistingIdTest()
    {
        ...
        await Assert.ThrowsAsync<EventNotFoundException>(() => _eventService.GetByIdAsync(id, CancellationToken.None));
    }
